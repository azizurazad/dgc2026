...
interface HeaderProps {
  ...
  onViewChange: (view: 'site' | 'admin') => void;
...
export default function Header({ 
  ...
  return (
    ...
    >
      ...
      >
        <div className="w-10 h-10 flex items-center justify-center border border-[#C79A6B] bg-[#111111] group-hover:border-[#F5F2EE] transition-all duration-500">
          <div className="w-6 h-6 bg-[#1F3D2B] flex items-center justify-center transition-transform duration-500 group-hover:rotate-12">
            <Leaf className="w-3.5 h-3.5 text-[#C79A6B]" />
          </div>
        </div>
