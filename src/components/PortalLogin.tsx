      ...
      >
        ...
        <div className="bg-[#111111]/90 border border-[#C79A6B]/20 rounded-xs p-6 md:p-8 backdrop-blur-xl shadow-2xl relative space-y-6">
          ...
          <form onSubmit={handleContinue} className="space-y-5 text-left">
            ...
            {/* Super Admin Info card helper */}
            <div className="border-t border-[#C79A6B]/10 pt-4 text-center">
              <p className="text-[9px] font-mono text-[#8F6A48]">
                Super Admin Test Credentials:
              </p>
              <div className="mt-2 text-[9px] font-mono text-[#C79A6B] bg-[#0B0B0B] p-2 border border-[#C79A6B]/10 select-all">
                Email: mr4233388@gmail.com | Roll: 73 <br /> Name: Masud Rana Bappii
              </div>
            </div>
