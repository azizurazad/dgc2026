...
export default function Philosophy() {
  ...
  return (
    <section 
      id="philosophy" 
      className="relative w-full py-24 md:py-36 bg-[#0B0B0B] text-[#F5F2EE] px-6 md:px-12 border-b border-[#C79A6B]/15"
    >
      ...
      <div className="w-full max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-24 items-start">
          ...
          >
            ...
            <div className="overflow-hidden rounded-xs bg-[#111111]">
              <motion.img 
                ...
                src="/src/assets/images/botanical_laboratory_interior_1783496441053.jpg" 
          ...
          <div className="lg:col-span-7 flex flex-col justify-center h-full space-y-10 md:space-y-12">
